...
int main()
{
	...
	Car* car_01 = new Car(spr_car_01_left, 9, 3, {80, 4}, {255, 0, 0}, map->map, {0, 1}, 0.15f);
	Car* car_02 = new Car(spr_car_01_left, 9, 3, {70, 4}, { 0, 255, 0 }, map->map, { 0, 1 }, 0.15f);
	Car* car_03 = new Car(spr_car_01_up, 5, 4, {60, 4}, { 0, 0, 255 }, map->map, { 0, 1 }, 0.15f);
