...
void inicializar_juego() {
	...
	Player* player = new Player({ 0, 0, 0 }, { 70,20 }, 10, spr_player, map_01->map);

	Car* car_01 = new Car(spr_car_01_left, 9, 3, { 149, 18 }, { 255, 0, 0 }, map_01->map, { -1, 1 }, 0.15f);
	...
	Car* car_02 = new Car(spr_car_01_right, 9, 3, { 2, 18 }, { 0, 255, 0 }, map_01->map, { 1, -1 }, 0.15f);
	...
	Car* car_03 = new Car(spr_car_01_up, 5, 4, { 81, 45 }, { 0, 0, 255 }, map_01->map, { 0, 1 }, 0.15f);
	...
	Car* car_04 = new Car(spr_car_02_down, 5, 4, { 81, 1 }, { 0, 0, 0 }, map_01->map, { 0, -1 }, 0.15f);
	Car* car_05 = new Car(spr_car_03_down, 5, 4, { 74, 1 }, { 0, 0, 0 }, map_01->map, { 0, -1 }, 0.15f);
	...
	Game* game = new Game(player, allies, traffic_lights, cars, maps, ui);
